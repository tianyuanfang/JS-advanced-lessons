//demo10
//1、移动号段有134,135,136,137,138,139,147,150,151,152,157,158,159,
...
// 移动号码： (11) ["13897516385", "15022457757", "15191936306", 
//"13933314962", "13455257780", "15916685067", "14701124042",
// "13895038245", "15873730173", "18828673819", "13814537603"]
// 联通号码： (14) ["18693949497", "13138569753", "13125634288", 
//"13240288945", "13098645914", "15603692153", "13089741902", 
//"15560351609", "13017332800", "15699699730", "18653855868",
// "13202536075", "17658565118", "13069428953"]
// 电信号码： (4) ["13335361211", "18168751105", "18937330815",
// "15324150371"]
// 其他号码： (2) [18168751105, 17658565118]
...
//使用正则表达式和数组相关的方法，将邮箱进行分类,要求分为4类，
//并存在4个对应的数组中
var emails = [
...
for(var i in emails)
{
    ...
    else if(reg2.test(emails[i]))
        sinaArray.push(emails[i]);
    else if(reg3.test(emails[i]))
        qqArray.push(emails[i]); 
    else
        otherArray.push(emails[i]); 
}

console.log("搜狐邮箱：",sohuArray);
console.log("新浪邮箱：",sinaArray);
console.log("qq邮箱：",qqArray);
console.log("其他邮箱：",otherArray);
